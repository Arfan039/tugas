                ...
                <div class="card-body">
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Ubah Produk
                        </div>
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('daftar-produk/update-produk/'.$data_produk->id_produk); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-6">
                                        ...
                                        <select name="kategori_slug" id="kategori_slug" class="form-control <?= $validation->hasError('kategori_slug') ? 'is-invalid' : null ?>">
                                            ...
                                            <?php foreach ($kategori_produk as $kategori) : ?>
                                                <option value="<?= $kategori->slug_kategori; ?>" <?= old('kategori_slug', $data_produk->kategori_slug) == $kategori->slug_kategori ? 'selected' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control <?= $validation->hasError('deskripsi') ? 'is-invalid' : null ?>"><?= old('deskripsi', $data_produk->deskripsi) ?></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img src="<?= base_url('asset-admin/img/'.$data_produk->gambar_produk) ?>" alt="" class="preview-img" width="100px">
                                    </div>

                                    <div class="justify-content-end d-flex">
                                        <button class="btn btn-primary btn-sm">Ubah Coy</button>
                                    </div>
                                </div>
                            </form>
                        </div>
